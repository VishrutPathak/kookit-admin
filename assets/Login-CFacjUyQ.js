import{r,u as v,a as j,j as e}from"./index-DyF85uUZ.js";function N(){const[s,n]=r.useState(""),[o,l]=r.useState(""),[d,c]=r.useState(""),[t,m]=r.useState(!1),[i,g]=r.useState(!1),{login:b}=v(),f=j(),h=async a=>{a.preventDefault(),m(!0),c(""),await new Promise(u=>setTimeout(u,800));const p=b(s.trim(),o);p.ok?setTimeout(()=>f("/dashboard"),600):(c(p.message||"Invalid credentials"),m(!1))},x=()=>{n("admin@kookit.io"),l("admin123")};return e.jsxs("div",{className:"login-container d-flex align-items-center justify-content-center p-3",children:[e.jsx("style",{children:`
    .login-container {
      min-height: 100vh;
